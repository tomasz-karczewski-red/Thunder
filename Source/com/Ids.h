...
namespace RPC {
    ...
    enum IDS {
        ...
        ID_CONTROLLER_SYSTEMINFO        = (ID_OFFSET_INTERNAL + 0x0008),
        ID_CONTROLLER_LIFETIME          = (ID_OFFSET_INTERNAL + 0x0009),
        ID_CONTROLLER_LIFETIME_NOTIFICATION = (ID_OFFSET_INTERNAL + 0x000A),
        ID_CONTROLLER_METADATA          = (ID_OFFSET_INTERNAL + 0x000B),
        ID_CONTROLLER_MANAGEMENT        = (ID_OFFSET_INTERNAL + 0x000C),
