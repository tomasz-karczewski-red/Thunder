...
namespace Plugin {
    ...
    public:
        ...
        uint32_t Register(Exchange::IController::ILifeTime::INotification* notification) override;
        uint32_t Unregister(Exchange::IController::ILifeTime::INotification* notification) override;
